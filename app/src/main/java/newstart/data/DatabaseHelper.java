...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertInitialRecipes(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Bowl Buddha com Grão-de-Bico', '<h1>Bowl Buddha</h1><h3>Ingredientes:</h3><ul><li>Grão assado, quinoa e espinafres, molho de sésamo</li></ul><h3>Preparação:</h3><p>Disponha os ingredientes numa taça e regue com o molho.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa de Cevada e Vegetais', '<h1>Sopa de Cevada</h1><h3>Ingredientes:</h3><ul><li>Cevada perlada, cenoura, aipo, batata</li></ul><h3>Preparação:</h3><p>Coza todos os ingredientes picados num caldo de legumes aromático.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Wrap de Falafel com Húmus', '<h1>Wrap de Falafel</h1><h3>Ingredientes:</h3><ul><li>Falafel, tortilha, húmus e salada</li></ul><h3>Preparação:</h3><p>Aqueça a tortilha, barre com húmus, coloque falafel e salada. Enrole.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa de Ervilha', '<h1>Sopa de Ervilha</h1><h3>Ingredientes:</h3><ul><li>Ervilhas secas, cebola, louro</li></ul><h3>Preparação:</h3><p>Coza as ervilhas com o refogado até ficarem macias e triture.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Tabule com Salsa Extra', '<h1>Tabule</h1><h3>Ingredientes:</h3><ul><li>Bulgur, muita salsa, hortelã, tomate</li></ul><h3>Preparação:</h3><p>Hidrate o bulgur e misture com os vegetais e ervas picadas.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa Minestrone', '<h1>Sopa Minestrone</h1><h3>Ingredientes:</h3><ul><li>Feijão, massa, tomate, legumes variados</li></ul><h3>Preparação:</h3><p>Coza os legumes com o tomate. Junte a massa e o feijão no final.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada de Feijão Frade', '<h1>Salada de Feijão Frade</h1><h3>Ingredientes:</h3><ul><li>Feijão frade, cebola, salsa, azeite</li></ul><h3>Preparação:</h3><p>Misture o feijão com a cebola e salsa picadas. Tempere bem.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Paella de Vegetais', '<h1>Paella de Vegetais</h1><h3>Ingredientes:</h3><ul><li>Arroz, açafrão, pimento, ervilhas</li></ul><h3>Preparação:</h3><p>Cozinhe o arroz com o açafrão e envolva os legumes salteados.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa de Repolho com Batatas', '<h1>Sopa de Repolho</h1><h3>Ingredientes:</h3><ul><li>Repolho, batata, cebola, alho</li></ul><h3>Preparação:</h3><p>Coza tudo num caldo simples e termine com um fio de azeite.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada de Grão Mediterrânea', '<h1>Salada de Grão</h1><h3>Ingredientes:</h3><ul><li>Grão cozido, tomate, pepino, azeitonas</li></ul><h3>Preparação:</h3><p>Misture tudo numa taça e tempere com azeite e limão.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Korma de Vegetais', '<h1>Korma de Vegetais</h1><h3>Ingredientes:</h3><ul><li>Mix de vegetais, leite de coco, especiarias</li></ul><h3>Preparação:</h3><p>Estufe os vegetais no leite de coco com as especiarias até amolecerem.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa de Feijão Branco e Couve', '<h1>Sopa de Feijão e Couve</h1><h3>Ingredientes:</h3><ul><li>Feijão branco, couve, alho</li></ul><h3>Preparação:</h3><p>Coza o feijão e junte a couve picada nos últimos minutos.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Lentilha Verde e Arroz (Mujadara)', '<h1>Mujadara</h1><h3>Ingredientes:</h3><ul><li>Lentilhas verdes, arroz integral, cebola frita</li></ul><h3>Preparação:</h3><p>Coza o arroz com as lentilhas. Cubra com cebola caramelizada.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada de Grão-de-Bico Assado', '<h1>Salada de Grão Assado</h1><h3>Ingredientes:</h3><ul><li>Grão assado crocante, mix de folhas</li></ul><h3>Preparação:</h3><p>Adicione o grão assado por cima de uma salada verde fresca.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Three Bean Chili', '<h1>Three Bean Chili</h1><h3>Ingredientes:</h3><ul><li>Feijão preto, vermelho e branco</li><li>Polpa de tomate e especiarias</li></ul><h3>Preparação:</h3><p>Cozinhe os feijões no molho de tomate bem temperado.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Brown Rice and Veggie Sushi', '<h1>Sushi Veggie</h1><h3>Ingredientes:</h3><ul><li>Arroz integral, folhas nori, vegetais</li></ul><h3>Preparação:</h3><p>Enrole o arroz e vegetais na alga e corte.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Gisado de Tomate e Lentilhas', '<h1>Gisado de Tomate</h1><h3>Ingredientes:</h3><ul><li>Lentilhas vermelhas, tomate pelado</li></ul><h3>Preparação:</h3><p>Cozinhe as lentilhas diretamente no molho de tomate temperado.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Quinoa com Romã', '<h1>Quinoa com Romã</h1><h3>Ingredientes:</h3><ul><li>Quinoa cozida, romã, hortelã</li></ul><h3>Preparação:</h3><p>Misture a quinoa com os bagos de romã e tempere com limão.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Barley and Mushroom Soup', '<h1>Sopa de Cevada e Cogumelos</h1><h3>Ingredientes:</h3><ul><li>Cevada perlada e mix de cogumelos</li></ul><h3>Preparação:</h3><p>Coza a cevada com os cogumelos picados num caldo de legumes.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa de Cevada e Cogumelos', '<h1>Sopa de Cevada e Cogumelos</h1><h3>Ingredientes:</h3><ul><li>Cevada perlada e mix de cogumelos</li></ul><h3>Preparação:</h3><p>Coza a cevada com os cogumelos picados num caldo de legumes.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Tofu and Broccoli with Peanut Sauce', '<h1>Tofu com Amendoim</h1><h3>Ingredientes:</h3><ul><li>Tofu, brócolos e manteiga de amendoim</li></ul><h3>Preparação:</h3><p>Grelhe o tofu e envolva tudo no molho de amendoim fluido.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Mexican Quinoa Bowl', '<h1>Mexican Bowl</h1><h3>Ingredientes:</h3><ul><li>Quinoa, feijão, milho, salsa</li></ul><h3>Preparação:</h3><p>Combine os ingredientes numa taça e envolva no molho salsa.</p>');");
        ...
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada Verde Mista com Sementes', '<h1>Salada com Sementes</h1><h3>Ingredientes:</h3><ul><li>Mix de folhas, sementes variadas</li></ul><h3>Preparação:</h3><p>Misture as folhas e junte sementes tostadas no topo.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Vegetable Stir-fry with Tempeh', '<h1>Salteado de Tempeh</h1><h3>Ingredientes:</h3><ul><li>Tempeh, vegetais variados, soja</li></ul><h3>Preparação:</h3><p>Salteie tudo em lume forte com molho de soja e gengibre.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Roasted Cauliflower with Tahini', '<h1>Couve-Flor com Tahini</h1><h3>Ingredientes:</h3><ul><li>Couve-flor, molho sésamo, limão</li></ul><h3>Preparação:</h3><p>Asse a couve-flor e cubra com o molho de tahine.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Baked Sweet Potato with Greens', '<h1>Batata-Doce com Verdes</h1><h3>Ingredientes:</h3><ul><li>Batata-doce, espinafres, alho</li></ul><h3>Preparação:</h3><p>Asse a batata e recheie com os verdes salteados.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Roasted Roots with Garlic Dip', '<h1>Raízes com Alho</h1><h3>Ingredientes:</h3><ul><li>Cenoura, beterraba, molho alho</li></ul><h3>Preparação:</h3><p>Asse as raízes e sirva com o molho fresco de alho.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada de Couve e Quinoa', '<h1>Salada de Couve</h1><h3>Ingredientes:</h3><ul><li>Couve kale, quinoa, nozes</li></ul><h3>Preparação:</h3><p>Misture a couve massajada com quinoa e nozes.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Espargos Assados com Amêndoas', '<h1>Espargos com Amêndoas</h1><h3>Ingredientes:</h3><ul><li>Espargos, amêndoas, azeite</li></ul><h3>Preparação:</h3><p>Asse os espargos e salpique com as amêndoas.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Pimentos Recheados com Arroz Selvagem', '<h1>Pimentos Recheados</h1><h3>Ingredientes:</h3><ul><li>Pimentos, arroz selvagem, ervas</li></ul><h3>Preparação:</h3><p>Recheie os pimentos e leve ao forno até dourarem.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Risoto de Cogumelos (Arroz Integral)', '<h1>Risoto de Cogumelos</h1><h3>Ingredientes:</h3><ul><li>Arroz integral, cogumelos, caldo</li></ul><h3>Preparação:</h3><p>Cozinhe o arroz lentamente com os cogumelos e caldo.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Lasanha de Beringela (Sem Queijo)', '<h1>Lasanha de Beringela</h1><h3>Ingredientes:</h3><ul><li>Beringela, tomate, creme caju</li></ul><h3>Preparação:</h3><p>Faça camadas de beringela e molho e leve a assar.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Tofu Agridoce', '<h1>Tofu Agridoce</h1><h3>Ingredientes:</h3><ul><li>Tofu, pimentos e molho agridoce</li></ul><h3>Preparação:</h3><p>Frite o tofu e envolva no molho agridoce.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Couve de Bruxelas com Balsâmico', '<h1>Bruxelas com Balsâmico</h1><h3>Ingredientes:</h3><ul><li>Couves bruxelas, vinagre balsâmico</li></ul><h3>Preparação:</h3><p>Asse as couves e regue com balsâmico.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Bok Choy Salteado com Tempeh', '<h1>Bok Choy Tempeh</h1><h3>Ingredientes:</h3><ul><li>Bok choy, tempeh, sésamo</li></ul><h3>Preparação:</h3><p>Salteie com alho e gengibre e finalize com sésamo.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Abóbora Assada com Quinoa', '<h1>Abóbora com Quinoa</h1><h3>Ingredientes:</h3><ul><li>Abóbora, quinoa, nozes</li></ul><h3>Preparação:</h3><p>Recheie a abóbora assada com a quinoa temperada.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Bifes de Cogumelo Portobello', '<h1>Bifes Portobello</h1><h3>Ingredientes:</h3><ul><li>Portobello, alho, ervas</li></ul><h3>Preparação:</h3><p>Grelhe os cogumelos inteiros com alho e ervas.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Bifes de Couve-Flor Especiados', '<h1>Bifes de Couve-Flor</h1><h3>Ingredientes:</h3><ul><li>Couve-flor, especiarias</li></ul><h3>Preparação:</h3><p>Asse fatias grossas de couve-flor bem temperadas no forno.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salteado de Brócolis e Caju', '<h1>Salteado com Caju</h1><h3>Ingredientes:</h3><ul><li>Brócolis, cajus, soja</li></ul><h3>Preparação:</h3><p>Salteie os vegetais e junte os cajus no final.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Beterraba Glaciada com Balsâmico', '<h1>Beterraba Glaciada</h1><h3>Ingredientes:</h3><ul><li>Beterraba, balsâmico</li></ul><h3>Preparação:</h3><p>Glacie a beterraba cozida com a redução de vinagre.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salada de Repolho e Cenoura', '<h1>Salada de Repolho</h1><h3>Ingredientes:</h3><ul><li>Repolho, cenoura, molho</li></ul><h3>Preparação:</h3><p>Misture tudo com um molho leve de limão.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Alcachofras ao Vapor', '<h1>Alcachofras</h1><h3>Ingredientes:</h3><ul><li>Alcachofras, limão</li></ul><h3>Preparação:</h3><p>Coza ao vapor e sirva com vinagrete.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Batata-Doce em Palitos Assada', '<h1>Palitos de Batata</h1><h3>Ingredientes:</h3><ul><li>Batata-doce, páprica</li></ul><h3>Preparação:</h3><p>Asse os palitos até ficarem dourados e crocantes.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Vagem Salteada com Alho', '<h1>Vagem com Alho</h1><h3>Ingredientes:</h3><ul><li>Vagem, alho, azeite</li></ul><h3>Preparação:</h3><p>Salteie a vagem cozida com muito alho.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Sopa Miso com Tofu', '<h1>Sopa Miso</h1><h3>Ingredientes:</h3><ul><li>Miso, tofu, algas</li></ul><h3>Preparação:</h3><p>Prepare o caldo de miso e junte o tofu em cubos.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Ervilhas de Quebrar Salteadas', '<h1>Ervilhas Salteadas</h1><h3>Ingredientes:</h3><ul><li>Ervilhas, sésamo</li></ul><h3>Preparação:</h3><p>Salteie rapidamente em lume forte.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Salteado de Abobrinha e Milho', '<h1>Curgete e Milho</h1><h3>Ingredientes:</h3><ul><li>Curgete, milho, ervas</li></ul><h3>Preparação:</h3><p>Salteie os dois com ervas frescas.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Mistura de Vegetais ao Vapor', '<h1>Mix de Vegetais</h1><h3>Ingredientes:</h3><ul><li>Legumes variados</li></ul><h3>Preparação:</h3><p>Coza ao vapor para manter os nutrientes.</p>');");
        db.execSQL("INSERT OR REPLACE INTO " + TABLE_RECIPES + " VALUES('Abóbora Menina Assada', '<h1>Abóbora Assada</h1><h3>Ingredientes:</h3><ul><li>Abóbora, canela</li></ul><h3>Preparação:</h3><p>Asse com um fio de azeite e sal até caramelizar.</p>');");
